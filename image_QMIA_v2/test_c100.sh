...
DROPPED_CLASSES=(2 7 12 17 22 27 32 37 42 47 52 57 62 67 72 77 82 87 92 97)
...
--batch_size=128 --image_size=224 --score_fn top_two_margin --loss_fn gaussian --cls_drop "${DROPPED_CLASSES[@]}" --checkpoint best_val_loss --rerun