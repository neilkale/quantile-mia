...
--batch_size=16 --base_image_size=224 --image_size=224 --epochs=10 --score_fn top_two_margin --loss_fn gaussian --cls_drop_range ${DROPPED_CLASSES} --rerun
...
--batch_size=128 --base_image_size=224 --image_size=224 --score_fn top_two_margin --loss_fn gaussian --cls_drop_range ${DROPPED_CLASSES} --checkpoint last --rerun